...
## **About Me**  
Excited to be at the cutting edge of AI & Data! I specialize in transforming complex data into strategic insights. I design and build scalable data platforms and intelligent data pipelines that deliver measurable business value. With expertise in SQL, Python, Snowflake, Power BI, Fabric, Azure, AWS, Alteryx, Power Automate, and SAP data ecosystems, I manage end to end data workflows from ETL/ELT and warehousing to automation and advanced analytics ensuring reliability, scalability, and high performance.
